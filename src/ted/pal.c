...
void LoadPalFile(unsigned char *filename, unsigned char *palette)
{
	FILE *file;
	unsigned char *ptr;
...
//	regset.x.dx = (unsigned short)VGAPAL; /* offset of array from which	to load RGB settings */
